...
import com.example.androidapp.util.convertDateToString
import com.example.androidapp.util.decodeThumbnailImage

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PostCard(post: com.example.androidapp.models.Post, onPostClick: (String) -> Unit) {
    ...
    )
    {
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Column(
                ...
                Text(
                    text = (post.date).toLong().convertDateToString(),
                    modifier = Modifier
                        .padding(bottom = 6.dp)
                        .alpha(0.5f),
